...
let names : string[] = ["Mark" , "Adil" , "Steave" , "Matthew"];
console.log(names[0])
console.log(names[1])
console.log(names[2])
console.log(names[3])
...
let message : string = "Would you join the class today for Type Scrip"
...
let transportation : string [] = ["Suzuki" , "Honda" , "yamaha"]
...
let guestList : string[] = ["Michelle" , "Naeem" , "Charlie" , "Mustafa"]

let unableToAttend : string = guestList.splice(0,2)[0];         // remove 1 guest by splise from List
